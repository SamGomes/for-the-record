    ...
    private void LoadEndScreenUIElements()
    {
        ...
        if (GameProperties.configurableProperties.isAutomaticalBriefing)
        {
            if (GameGlobals.currGameId >= GameProperties.configurableProperties.numSessionGames - 1)
            {
                ...
                infoPoppupNeutralRef.DisplayPoppup("You reached the end of the game. Please write down your score, as well as the following gamecode, and fill the questionnaire to finish the experiment.");
                //UIEndGameButton.gameObject.SetActive(true);
                //UIEndGameButton.interactable = true;
                //UIEndGameButtonText.text = "Final Notes";
                UIWarningText.text = "You reached the end of the game. Please write down your score, as well as the following gamecode, and fill the questionnaire to finish the experiment.";
